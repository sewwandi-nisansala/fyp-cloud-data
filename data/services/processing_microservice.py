...
passenger_data_automated = RepeatedTimer(5, get_passenger_count_data_fog)
window_data_automated = RepeatedTimer(5, get_window_opening_data_fog)
ac_data_automated = RepeatedTimer(5, get_air_condition_data_fog)
pitch_data_automated = RepeatedTimer(5, get_pitch_data_fog)
rain_intensity_data_automated = RepeatedTimer(5, get_rain_intensity_data_fog)
visibility_data_automated = RepeatedTimer(5, get_visibility_data_fog)
driver_rush_data_automated = RepeatedTimer(5, get_driver_rush_data_fog)
speed_data_automated = RepeatedTimer(5, get_speed_data_fog)
